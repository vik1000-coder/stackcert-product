    ...
    <Card style={{ marginBottom: 16 }}>
      <div className="pilot-readiness-head">
        <div>
          ...
          <h2 className="pilot-readiness-title">First useful evidence packet</h2>
      ...
      <div className="pilot-readiness-grid">
        ...
        <div className="pilot-boundary">
          <Badge tone="warn">Scoped evidence</Badge>
          ...
          <div className="pilot-boundary-list">
            ...
            <span>Use release gates to check evidence status and context before deploy.</span>
          </div>
        </div>
      </div>
    </Card>
