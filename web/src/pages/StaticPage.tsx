...
const pages: Record<string, StaticContent> = {
  'why-stackcert': {
    ...
    sections: [
      ...
      { heading: 'The outcome', body: 'Teams get an app-specific recommendation and a release evidence report that says what was tested, what was not, and when to retest.' }
    ]
  },
  'how-it-works': {
    eyebrow: 'Product',
    ...
    sections: [
      ...
      { heading: 'Review before release', body: 'Export a release evidence report, collect signoffs, and use API, CLI, GitHub Actions, or MCP resources to block or warn on deployments.' }
    ]
  },
  pricing: {
    eyebrow: 'Product',
    ...
    sections: [
      { heading: 'Starter', body: 'Free local/demo use for one application, uploaded outputs, and one active release evidence report.' },
  ...
  docs: {
    ...
    sections: [
      ...
      { heading: 'Release', body: 'Issue a release evidence report, collect signoffs, and connect the result to CI/CD or LLM app-release tooling with GitHub Actions, GitLab, CircleCI, or webhook templates.' }
    ]
  },
  'methodology-paper': {
    eyebrow: 'Resources',
  ...
  blog: {
    ...
    sections: [
      { heading: 'First posts', body: 'Why one-at-a-time safety scores fail, what release evidence reports mean, and how to decide when to retest.' },
  ...
  glossary: {
    ...
    sections: [
      ...
      { heading: 'Release evidence report', body: 'A scoped review record that says what examples and safety-check combinations were tested, what StackCert recommends, what is not covered, and when to retest.' },
  ...
  about: {
    ...
    sections: [
      ...
      { heading: 'Point of view', body: 'No release report proves universal safety. Good release evidence makes scope, assumptions, and residual risk explicit.' },
  ...
  press: {
    ...
    sections: [
      ...
      { heading: 'Long description', body: 'StackCert measures where safety options overlap, ranks candidate combinations, and produces scoped release evidence reports for review.' },
