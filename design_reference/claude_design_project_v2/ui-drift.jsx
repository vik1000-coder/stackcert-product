...
function SignalRow({ d, idx, active, onClick }) {
  return (
    <div onClick={onClick} role="button" tabIndex={0}
      className={'u-row '+(active?'u-selected':'')}
      style={{ display:'grid', gridTemplateColumns: '14px 1.5fr 1.6fr 1.2fr 110px',
        alignItems:'center', gap: 16, padding:'14px 18px',
        borderTop: idx?'1px solid '+U.line:'none',
        cursor:'pointer', background: active?U.accentSoft+'80':'transparent' }}>
